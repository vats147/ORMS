					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li>
									<a href="managecategory.html" class="dropdown-toggle no-arrow">
										<!-- <i class="icon-copy dw dw-analytics-4"></i> -->
										<span class="micon bi bi-currency-rupee"></span
						...
						<li>
							<a href="manageexpenses.html" class="dropdown-toggle no-arrow">
								<!-- <i class="icon-copy dw dw-analytics-4"></i> -->
								<span class="micon bi bi-currency-rupee"></span
						...
						<li>
							<a href="contactus.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-chat-right-dots"></span
								><span class="mtext">Contact Us</span>
							</a>
						</li>
						<li>
							<a href="feedback.html" class="dropdown-toggle no-arrow">
						...
						<li>
							<a href="managegallery.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-images"></span
						...
						<li>
							<a href="managetable.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-images"></span
						...
						<li>
							<a href="managebranch.html" class="dropdown-toggle no-arrow">
						...
						<li>
							<a href="manageemployee.html" class="dropdown-toggle no-arrow">
