...
<?php 
    ...
    $did=$try="";
    $uid=$uname=$uadd=$ucity=$upincoe=$ucontact="";
?>
...
<?php
    ...
    if (isset($_POST['btndone'])) {
        $did=$_POST['deleteid'];
        $sql = "DELETE FROM `tblbranch` WHERE `branchcode`='$did'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            header("location:managebranch.php");
        }
    ...
    if (isset($_POST['editbranch']))
    {
        ...
        $uadd=$_POST['updateadd'];
        $ucity=$_POST['updatecity'];
        $upincoe=$_POST['updatepin'];
        $ucontact=$_POST['updatecontact'];; 
        if(isset($_POST['updatename']))
        {
         $sql="UPDATE `tblbranch` SET `name`='$uname',`address`='$uadd',`city`='$ucity',`pincode`='$upincoe',`brContactNo`='$ucontact' WHERE `branchcode`='$uid'";
         
        //  $sql="UPDATE `tblbranch` SET `branchcode`='$uname' WHERE `branchcode`='$uid'";
         $result = mysqli_query($conn, $sql);
         if ($result) {
            header("location:managebranch.php");
        }
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <!-- //branch update -->
                                                            <td>
                                                            <button data-toggle="modal" data-target="#bd-example-modal-lg<?php echo $row['branchcode']?>" class="dropdown-item" class="btn-block">
                                                                    <i class="dw dw-edit2"></i>Edit</button>
                                                            </td>
                                                            <!-- //branch delete -->
                                                            <td>
                                                                <a class="btn-block" data-toggle="modal" data-target="#success-modal<?php echo $row['branchcode']?>" type="button" >
                                                                <i class="dw dw-delete-3"></i> Delete</a>
                                                            </td>
                                                            <!-- Edit form        edit modal  #bd-example-modal-lg -->
                                                            <div class="col-md-4 col-sm-12 mb-30">
                                                                <div class="modal fade bs-example-modal-lg" id="bd-example-modal-lg<?php echo $row['branchcode']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog modal-lg modal-updialog-centered">
                                                                        <div class="modal-content">
                                                                                ...
                                                                                <form method="POST">
                                                                                    <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-10">
                                                                                            <input type="hidden" id="hiddencode" name='hiddenid' value="<?php echo $row['branchcode'];?>">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button name="editbranch" class="btn btn-primary" type="submit">
                                                                                    Save changes
                                                                                </button>
                                                                                </form>
                                                                            </div>
