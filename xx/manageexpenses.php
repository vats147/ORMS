...
<body>
											...
											<div class="min-height-200px">
												...
												<div class="pd-20 card-box mb-30">
													...
													<form id="form">
														...
														<div class="form-group row">
															<label class="col-sm-12 col-md-2 col-form-label">Branch Code
																* </label>
															<div class="col-sm-12 col-md-10">
																<?php
	...
	<script>
		...
		$('#branchcode').on("change", function () {
			...
			bcode = document.getElementById("branchcode").value;
			...
			if (bcode) {
				...
				document.getElementById("error4").innerHTML = "Please select BranchCode";
			}
		...
		$(document).on("click", "#done", function () {
			...
			if (validexpensetype && validbranchcode && validexpensevalue) {
				$.ajax({
					url: "retrivedata.php",
					type: "POST",
					data: {
