        ...
        <div class="row">
            <div class="col-md-6">
                <div id="slider" class="owl-carousel product-slider">
                    <div class="item">
                        <img
                            src="./assets/images/r16.jpeg" />
                    </div>
                    <div class="item">
                        <img src="./assets/images/r16.jpeg" />
                    </div>
                    <div class="item">
                        <img
                           src=" ./assets/images/r16.jpeg" />
            ...
            <div class="col-md-6">
                <div class="product-dtl">
                    <div class="product-info">
                        <div class="product-name"> Masla Dhosa</div>
                        ...
                        <div class="product-price-discount"><span>239.00</span><span class="line-through">$29.00</span>
                        </div>
                    </div>
                    ...
                    <div class="product-count">
                        ...
                        <a href="temp.php" class="round-black-btn">Add to Cart</a>
                    </div>
                </div>
            </div>
        </div>
